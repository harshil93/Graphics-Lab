...
typedef struct
{
  ...
  double p1x, p1y, p1z; // first point of reflection plane 
  double p2x, p2y, p2z; // second point of reflection plane
  double p3x, p3y, p3z; // third point of reflection plane
